    ...
    <div className="min-h-screen bg-gradient-to-br from-primary via-secondary to-accent flex items-center justify-center">
      ...
      >
        <div className="bg-white rounded-xl shadow-2xl p-8">
          <h1 className="text-3xl font-bold text-primary mb-2 text-center">Login</h1>
          <p className="text-gray-600 text-center mb-8">Welcome back to Carbon Coach</p>
          ...
          <p className="text-center mt-6 text-gray-600">
            ...
            <Link to="/register" className="text-secondary font-semibold hover:text-primary">
              Sign up
            </Link>
          </p>
        </div>
